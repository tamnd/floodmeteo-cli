...
Most of these come down to network reality or how floodmeteo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

floodmeteo rate-limits like any public site. floodmeteo already paces
...
Where a surface is gated, floodmeteo reads a cookie or token you supply
...
`floodmeteo`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what floodmeteo actually did
