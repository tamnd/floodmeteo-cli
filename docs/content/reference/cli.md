...
```
floodmeteo <command> [arguments] [flags]
```

Run `floodmeteo <command> --help` for the full flag list on any command. This
...
per operation you declare in `floodmeteo/domain.go`.
