...
// HTTP behaviour is covered in floodmeteo_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "floodmeteo://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("floodmeteo", "about")
	if err != nil || got.String() != "floodmeteo://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want floodmeteo://page/about", got.String(), err)
	}
}
